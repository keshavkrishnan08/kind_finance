...
Recent work has begun to bridge non-equilibrium physics and
finance---Ducuara \emph{et al.}~\cite{ducuara2023maxwell} established a
rigorous connection between Crooks' fluctuation relations and expected
utility theory, and Rold{\'a}n and
Parrondo~\cite{roldan2010estimating} developed methods for estimating
dissipation from single trajectories. Non-equilibrium statistical
mechanics offers precisely this
...
(Eq.~\ref{eq:ep_total}) reveals that a small number of modes
...
scales, but provided no spectral decomposition of the violation or
pointwise localization---gaps that KTND directly addresses.
